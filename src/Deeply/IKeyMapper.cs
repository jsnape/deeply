...
// <copyright file="IKeyMapper.cs" company="James Snape">
...
namespace Deeply
{
    ...
    /// <summary>
    /// <c>IKeyMapper</c> interface definition.
    /// </summary>
    /// <typeparam name="T">Surrogate key type.</typeparam>
    public interface IKeyMapper<T> where T : struct
    {
        /// <summary>
