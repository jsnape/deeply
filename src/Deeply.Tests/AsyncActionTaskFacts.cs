...
// <copyright file="AsyncActionTaskFacts.cs" company="James Snape">
...
namespace Deeply.Tests
{
    ...
    /// <summary>
    /// AsyncActionTask facts.
    /// </summary>
    public static class AsyncActionTaskFacts
    {
        /// <summary>
        ...
        {
            var exception = Assert.Throws<ArgumentNullException>(() => new AsyncActionTask(null));
